         ...
         <form method="POST" action="{{route('admin-update-coachCat')}}" enctype="multipart/form-data" >
          ...
          <div class="row">
            ...
            <div class="col-md-4 grid-margin w-100 bg-img">
             ...
             <center><div id="img_error" style="color:red">{{ $errors->first('cat_img') }}</div></center>
          </div>
            ...
            <div class="col-md-8 grid-margin stretch-card">
              <div class="card">
                <div class="card-body row">
                   ...
                   <input type="text" name="categoryName" value="{{ $Category->categoryName }}" class="form-control form-control-lg" id="" placeholder="Category Name">
                   <div id="name_error" style="color:red">{{ $errors->first('categoryName') }}</div>
                   </div>
