            ...
            @endif
              ...
              <div class="card">
                ...
                <div class="card-body row">
                   ...
                   <input type="text" name="name" class="form-control form-control-lg" id="" placeholder="Enter Name">
                  ...
                  <div class="dropdown">
                          ...
                          <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton4" style="">
                           @php $ide = $masterCategory->id; @endphp
                            ...
                            <!-- <a onclick="return confirm('Are you sure?');" class="dropdown-item" href="{{ route('admin-mcategory-delete',$ide) }}">Delete </a> -->
