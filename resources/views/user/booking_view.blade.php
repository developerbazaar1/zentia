    			...
    			<div class="card-body">
    				<div class="row">
    					...
    					<div class="form-group col-lg-12 mb-1">
    					    ...
    					    <div class="d-flex align-items-center mb-4">
    					        <h5 class="text-white booking-status">Meeting Start Time Timezone-(Europe/Brussels) </h5>
                            ...
                            @endphp
    					    <div class="d-flex align-items-center mb-4">
    					        <h5 class="text-white booking-status">Meeting Start Time Timezone-(@php echo $user_timezone; @endphp)</h5>
