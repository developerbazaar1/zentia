        ...
        <div class="invoice-wrap my-5">
            ...
            <div class="invoice-content">
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6">
                        <div class="about-zentia mb-5">
                            <h3 class="coach-name roboto text-main mb-3">About Zentia</h3>
                            <p class="roboto text-white">Lorem Ipsum is simply dummy text of the printing and typesetting industry the printing and typesetting industry.</p>
                        </div>
                ...
                <div class="invoice-table-wrap mb-5">
                    <table class="table roboto mb-0">
                        ...
                        <tbody class="invoice-table-body">
                            ...
                            <tr>
                                ...
                                <td>{{ array_sum($time_session) }} Min.</td>
                                <td>{{ $token_one[$key] }}</td>
                                <td>${{ $value }} </td>
                            </tr>
                           @php $i++; @endphp
            ...
            <img src="{{ asset('assets/media/wave-bottom.png') }}" alt="" class="invoice-bg-img">
        </div>
    </div>
