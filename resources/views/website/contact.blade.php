    ...
    <section class="contact-info-section mb-5 py-5 bg-gray">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 pe-4 position-relative d-flex">
                   ...
                   <div class="work-card-wrap text-center py-5 px-3">
                        ...
                        <a href="#" class="text-center work-card-text contact-card-text roboto">demo@gmail.com</a>
                   </div> 
                </div>
                <div class="col-md-4 pe-4 position-relative d-flex">
                    <div class="how-it-word-overlay advisor-overlay"></div>
                ...
                <div class="col-md-4 pe-4 position-relative d-flex">
                 <div class="how-it-word-overlay advisor-overlay"></div>
                     <div class="work-card-wrap text-center py-5 px-3">
                        ...
                        <p class="text-center work-card-text contact-card-text roboto">Akshya Nagar 1st Block 1st Cross, Rammurthy nagar, Bangalore-560016</p>
                     </div> 
                </div>
            </div>
        </div>
