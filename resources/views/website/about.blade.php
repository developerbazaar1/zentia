    ...
    <section class="about-desc-section position-relative py-5">
        ...
        <div class="container">
            <div class="about-us-content">
                ...
                <p class="roboto text-main mb-5">Zentia is an exclusive digital gateway for people who want to connect with accomplished tier 1 entrepreneurs and executives 2-3 steps ahead of them for insightful 1:1 digital sessions.</p>
            </div>
        </div>
    </section>
