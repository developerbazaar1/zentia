...
@section('content')
    ...
    <section class="featured-section">
        <div class="container">
            ...
            <div class="logo-row justify-content-center align-items-center pb-4"> 
                <div>
                    <img class="img-fluid logos" src="{{ URL::asset('assets/media/logo-1.png') }}">
                </div>
               <div>
                    <img class="img-fluid logos" src="{{ URL::asset('assets/media/logo-2.png') }}">
               </div>
               <div>
                    <img class="img-fluid logos" src="{{ URL::asset('assets/media/logo-3.png') }}">
                </div>
               <div>
                    <img class="img-fluid logos" src="{{ URL::asset('assets/media/logo-4.png') }}">
               </div>
               <div>
                    <img class="img-fluid logos" src="{{ URL::asset('assets/media/logo-5.png') }}">
               </div>
            </div>
        </div>
    </section>
    ...
    <section class="how-it-works-section bg-gray py-5">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 pe-4 pe-sm-5 position-relative mb-sm-0 mb-5">
